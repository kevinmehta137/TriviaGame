...
$(document).ready(function() {
    ...
    function Loss() {
        incorrectTally++;
        gameHTML = "<p class='text-center timer-p'>Time Remaining: <span class='timer'>" + counter + "</span></p>" + "<p class='text-center'>Wrong! The correct answer is: "+ correctAnswers[questionCounter] + "</p>" + "<img class='center-block img-wrong' src='./assets/img/Asset 1.png'>";
        $(".mainArea").html(gameHTML);
        setTimeout(wait, 3000); //  change to 3000 or other amount
    }
